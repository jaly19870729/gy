...
{
    public partial class NoCardBackCardCast : Form
    {
        ...
        private void NoCardBackCardCast_Load(object sender, EventArgs e)
        {
            Init();
        }
        ...
        private void Init()
        {
            ...
            this.txt_ChangeAmount.Text = Convert.ToString(backCardInfo.ChangeAmount);
            ...
            this.txt_PatchAmount.Text = Convert.ToString(backCardInfo.PatchAmount);
        }
        #endregion
