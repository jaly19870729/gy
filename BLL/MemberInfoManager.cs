...
namespace Gymnasium_APP.BLL
{
	...
	{
		private readonly Gymnasium_APP.DAL.MemberInfoDal dal=new Gymnasium_APP.DAL.MemberInfoDal();
		...
		/// 获得数据列表
		/// </summary>
		public List<Gymnasium_APP.Model.MemberInfoModel> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Gymnasium_APP.Model.MemberInfoModel> DataTableToList(DataTable dt)
		{
			List<Gymnasium_APP.Model.MemberInfoModel> modelList = new List<Gymnasium_APP.Model.MemberInfoModel>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Gymnasium_APP.Model.MemberInfoModel model;
