...
{
	/// <summary>
	/// 数据访问类:CunsumeTypeDal
	/// </summary>
	public partial class CunsumeTypeDal
	{
		public CunsumeTypeDal()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "CunsumeType"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from CunsumeType");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update CunsumeType set ");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from CunsumeType ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,CusType,CusPrice,CreateTime ");
			strSql.Append(" FROM CunsumeType ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,CusType,CusPrice,CreateTime ");
			strSql.Append(" FROM CunsumeType ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from CunsumeType T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "CunsumeType";
