...
{
	/// <summary>
	/// 数据访问类:PositionInfoDal
	/// </summary>
	public partial class PositionInfoDal
	{
		public PositionInfoDal()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "PositionInfo"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from PositionInfo");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update PositionInfo set ");
			...
			parameters[4].Value = model.PState;
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from PositionInfo ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)			};
			parameters[0].Value = ID;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,Name,Price,Des,TypeName,PState ");
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from PositionInfo T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "PositionInfo";
