...
{
	/// <summary>
	/// 数据访问类:MemberHistoryInfoDal
	/// </summary>
	public partial class MemberHistoryInfoDal
	{
		public MemberHistoryInfoDal()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("MemberID", "MemberHistoryInfo"); 
		}
		...
		public bool Exists(int MemberID)
		{
			...
			strSql.Append("select count(1) from MemberHistoryInfo");
		...
		public bool Delete(int MemberID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from MemberHistoryInfo ");
			strSql.Append(" where MemberID=@MemberID");
			SqlParameter[] parameters = {
					new SqlParameter("@MemberID", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select MemberID,CardID,Mail,CardType,IDCardType,Name,IDCard,Sex,StartTime,Birthday,EndTime,Phone,Count,Unit,AddTime,AddUserName,InfoType,Photo ");
			strSql.Append(" FROM MemberHistoryInfo ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" MemberID,CardID,Mail,CardType,IDCardType,Name,IDCard,Sex,StartTime,Birthday,EndTime,Phone,Count,Unit,AddTime,AddUserName,InfoType,Photo ");
			strSql.Append(" FROM MemberHistoryInfo ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from MemberHistoryInfo T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "MemberHistoryInfo";
